 ...
 */
export function buildHierarchicalId(...parts: string[]): string {
 ...
 */
export function generateFloorTileId(
  prefix: string,
  assetType: string,
  index: number
): string {
 ...
 */
export function generateSpawnPointId(
  hqId: string,
  teamNumber: number,
  spawnIndex: number
): string {
 ...
 * @param teamNumber Team number (1 or 2)
 */
export function generateHQAreaId(hqId: string, teamNumber: number): string {
 ...
 */
export function generateCombatPolygonId(combatAreaId: string): string {
