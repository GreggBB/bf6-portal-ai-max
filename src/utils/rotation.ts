...
export function createIdentity(): RotationMatrix {
  return {
    right: { x: 1, y: 0, z: 0 },
    up: { x: 0, y: 1, z: 0 },
    front: { x: 0, y: 0, z: 1 },
 ...
 */
export function createYawRotation(degrees: number): RotationMatrix {
 ...
 * Used for DeployCam
 */
export function createTopDown(): RotationMatrix {
  return {
    right: { x: 1, y: 0, z: 0 },
    up: { x: 0, y: 0, z: -1 },
    front: { x: 0, y: 1, z: 0 },
 ...
 */
export function createY90(): RotationMatrix {
 ...
 */
export function createFacingDirection(direction: Vector3): RotationMatrix {
