...
export {
  generateDeployCam,
  generateDeployCamOverPlatform,
  type DeployCamConfig,
} from './generators/deploy-cam.js';

// Builder
export {
  SpatialBuilder,
  createBuilder,
  type TeamSpawnOptions,
  type CombatAreaOptions,
  type DeployCamOptions,
} from './builder.js';
...
export {
  ...
  createLargePlatform,
  createArenaPlatform,
  type TestingPlatformOptions,
} from './presets/testing-platform.js';
